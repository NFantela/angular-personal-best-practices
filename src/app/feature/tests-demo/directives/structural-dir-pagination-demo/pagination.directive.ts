...
/**
 * Example of structural directive that renders content in its viewContainer based on pagination inputs
 *       <li
...
export class PaginateDirective<T> implements OnChanges {
  ...
  // inputs match following : *appPaginate="let item of items; perPage: 3; controls: controls
  @Input()
